...
import components.human_parse.networks as networks
from components.human_parse.utils.transforms import transform_logits
from components.human_parse.datasets.simple_extractor_dataset import SimpleFolderDataset
...
def main(dataset, model_restore, input_dir, output_dir):
    # args = get_arguments()
    ...
    simple_dataset = SimpleFolderDataset(root=input_dir, input_size=input_size, transform=transform)
